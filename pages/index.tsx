...
import { chainName, cw20ContractAddress, dependencies, products } from '../config';
...
export default function Home() {
  ...
  const { getSigningCosmWasmClient, address, isWalletConnected } = useChain(chainName);
    ...
    if (isWalletConnected === true)
      getSigningCosmWasmClient().then((cosmWasmClient) => {
        if (!cosmWasmClient || !address) {
          console.error("No SigningCosmWasmClient or no address");
          return;
        }
  ...
  return (
    <Container maxW="5xl" py={10}>
      ...
      <WalletSection />
      <p>Your balance is: {balance} tokens</p>
